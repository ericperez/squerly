...
class Inflector {
  ...
  public static function uncountable($str)
  {
    ...
    {
      // Cache uncountables
      Inflector::$uncountable = self::getUncountableWords();
  ...
  public static function singular($str, $count = NULL)
  {
    ...
    if (empty(Inflector::$irregular))
    {
      ...
      Inflector::$irregular = self::getIrregularWords();
    }
  ...
  //Irregular words
  public static function getIrregularWords() {
    return array(
      'child' => 'children',
      'clothes' => 'clothing',
      'man' => 'men',
  ...
  //Uncountable words
  public static function getUncountableWords() {
    return array(
      'access',
      'advice',
      'aircraft',
