...
/**
  *
  * Squerly - Transformation class to calculate mean average values in a 2D array
  * 
  * 
  ...
  * 
  */
class Transform_Mean implements Transform_Interface {


/**
  *
  * Calculates the mean average across all series of a two-dimensional data array
  * 
  ...
  */
  public static function run(array $data, array $fields = array()) {
    ...
    foreach($data as $row) {
      ...
      $output[] = array($y_col => $y_val, 'MEAN' => array_sum($vals) / sizeof($vals));
    }
    return $output;
  }
