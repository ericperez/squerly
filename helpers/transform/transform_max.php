...
/**
  *
  * Squerly - Transformation class to calculate maximum value across series in a 2D array
  * 
  * 
  ...
  * 
  */
class Transform_Max implements Transform_Interface {


/**
  *
  * Find the maximum value across all series of a two-dimensional data array
  * 
  ...
  */
  public static function run(array $data, array $fields = array()) {
    ...
    foreach($data as $row) {
      ...
      $output[] = array($y_col => $y_val, 'MAX' => max($vals));
    }
    return $output;
  }
